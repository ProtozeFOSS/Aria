...
export class Aria {
  ...
  constructor(public aria: AriaService,
    ...
    private route: ActivatedRoute){
      ...
      // this.aria.setContextMenuItem('Copy FEN', ()=>{console.log('Copy Fen:'); console.log(this.aria.FEN())}, 'clipboard');
      //this.aria.loadUrlHash('');
    }
    ngAfterViewInit() {
